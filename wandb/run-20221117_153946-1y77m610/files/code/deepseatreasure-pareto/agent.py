...
class Pareto():
    ...
    def send_wandb_metrics(self):
        for e in range(self.numberofeps):
            ...
            log_dict3 = {
                    "rewards0":self.rewards0[e],
                    "rewards1":self.rewards1[e],
                    "paretoreward0":self.paretorew0[e],
                    "paretoreward1":self.paretorew1[e],
...
if __name__ == '__main__':
    ...
    agent.train(2500,1500,log = True,plot_paretofront=True)
